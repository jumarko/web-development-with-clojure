...
Request middleware functions are located under the `oauth-example.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `oauth-example.dev-middleware` namespace found in
